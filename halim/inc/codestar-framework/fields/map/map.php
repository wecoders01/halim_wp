    ...
    class CSF_Field_map extends CSF_Fields {
        ...
        public function render() {
            ...
            $args = wp_parse_args( $this->field, array(
                'placeholder'    => esc_html__( 'Search...', 'halim' ),
                'latitude_text'  => esc_html__( 'Latitude', 'halim' ),
                'longitude_text' => esc_html__( 'Longitude', 'halim' ),
                'address_field'  => '',
                'height'         => '',
            ) );
        ...
        public function enqueue() {
            ...
            if ( !wp_script_is( 'csf-leaflet' ) ) {
                wp_enqueue_script( 'csf-leaflet', esc_url( $this->cdn_url . $this->version . '/dist/leaflet.js' ), array( 'halim' ), $this->version, true );
            }
