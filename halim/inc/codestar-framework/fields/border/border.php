    ...
    class CSF_Field_border extends CSF_Fields {
        ...
        public function render() {
            ...
            $args = wp_parse_args( $this->field, array(
                ...
                'top_placeholder'    => esc_html__( 'top', 'halim' ),
                'right_placeholder'  => esc_html__( 'right', 'halim' ),
                'bottom_placeholder' => esc_html__( 'bottom', 'halim' ),
                'left_placeholder'   => esc_html__( 'left', 'halim' ),
                'all_placeholder'    => esc_html__( 'all', 'halim' ),
                'top'                => true,
                'left'               => true,
                'bottom'             => true,
                'right'              => true,
            ...
            $border_props = array(
                'solid'  => esc_html__( 'Solid', 'halim' ),
                'dashed' => esc_html__( 'Dashed', 'halim' ),
                'dotted' => esc_html__( 'Dotted', 'halim' ),
                'double' => esc_html__( 'Double', 'halim' ),
                'inset'  => esc_html__( 'Inset', 'halim' ),
                'outset' => esc_html__( 'Outset', 'halim' ),
                'groove' => esc_html__( 'Groove', 'halim' ),
                'ridge'  => esc_html__( 'ridge', 'halim' ),
