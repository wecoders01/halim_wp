...
<div class="csf-welcome csf-welcome-wrap">
  ...
  <p class="csf-demo-button"><a href="<?php echo esc_url( add_query_arg( array( 'csf-demo' => $status ) ) ); ?>" class="button button-primary<?php echo esc_attr( $class ); ?>"><?php echo $text; ?><?php esc_html_e( 'Demo', 'halim' );?></a></p>
